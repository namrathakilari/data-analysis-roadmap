# 📊 Healthcare Waitlist Dashboard Overview

This project provides insights derived from a healthcare waitlist dashboard covering the period from **31 January 2018 to 31 March 2021**. The dashboard visualizes patient data across multiple dimensions including case types, age profiles, specialties, and wait times.
